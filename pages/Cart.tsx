                        ...
                        {items.map(item => (
                            <div key={item.id} className="bg-white rounded-2xl p-3 flex items-center gap-3 shadow-sm border border-amber-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-amber-700 font-bold text-sm">{item.price} {t.common.TND}</p>
                                ...
                                <div className="flex flex-col items-end gap-2">
                                    ...
                                    <span className="font-bold text-amber-800 text-sm">{(item.price * item.quantity).toFixed(2)} {t.common.TND}</span>
                                </div>
                            </div>
                        ))}
                    </div>
