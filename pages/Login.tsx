    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-amber-900">Bienvenue</h1>
            <p className="text-sm text-gray-500 mt-1">Connectez-vous pour commander</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 border border-amber-100">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={loading}
                    ...
                    {loading ? <><Loader className="animate-spin" size={18} /> Chargement...</> : mode === 'signin' ? 'Se connecter' : "S'inscrire"}
                </button>
            </form>
