...
import { Home, ShoppingBag, User, Search, ShoppingCart, LayoutDashboard, LogIn, LogOut, Package, Facebook, Instagram, MessageCircle } from 'lucide-react';
      ...
      <footer className="bg-amber-900 text-amber-100 py-6 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a href="https://www.instagram.com/rahiq.store/" target="_blank" rel="noopener noreferrer"
